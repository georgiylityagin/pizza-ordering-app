  ...
  return (
    <li className='cart-item'>
      ...
      <div className='cart-item__controls'>
        <button className='cart-item__change-quantity' onClick={handleDecrease}>
          -
        </button>
        <span className='cart-item__quantity'>{quantity}</span>
        <button className='cart-item__change-quantity' onClick={handleIncrease}>
          +
        </button>
      </div>

      <div className='cart-item__price'>
        <div className='cart-item__price-dollars'>{price.toFixed(2)} &#36;</div>
